        ...
        <div class="mt-3 p-3" style="border:solid #ccc 1px; background-color:#F8F8FF;">
            <form action="<?= base_url('customers/saveCustomer') ?>" method="POST" id="form1" enctype="multipart/form-data">
                ...
                <div class="row form-group mt-3 p-2">
                    <div class="col-md-4 form-group">
                        <div class="form-check">
                            <input id="addcus_company_sln" class="form-check-input" type="radio" name="addcus_company" value="sln">
                            <label for="my-input" class="form-check-label">Salee Colour Public Company Limited.</label>
                        </div>
                    </div>
                    <div class="col-md-4 form-group">
                        <div class="form-check">
                            <input id="addcus_company_poly" class="form-check-input" type="radio" name="addcus_company" value="poly">
                            <label for="my-input" class="form-check-label">Poly Meritasia Co.,Ltd.</label>
                        </div>
                    </div>
                    <div class="col-md-4 form-group">
                        <div class="form-check">
                            <input id="addcus_company_ca" class="form-check-input" type="radio" name="addcus_company" value="ca">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4 form-group">
                        <div class="form-check">
                            <input id="addcus_addresstype1" class="form-check-input" type="radio" name="addcus_addresstype" value="ตาม ภ.พ.20">
                            <label for="my-input" class="form-check-label">ตาม ภ.พ.20</label>
                        </div>
                    </div>
                    <div class="col-md-4 form-group">
                        <div class="form-check">
                            <input id="addcus_addresstype2" class="form-check-input" type="radio" name="addcus_addresstype" value="อื่นๆ">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" name="addcus_regiscost" id="addcus_regiscost" class="form-control form-control-sm">
                    </div>

                    <div class="col-md-6">
                        <div id="">
                            <label for="">แผนที่ (ลิ้งจาก Googlemap)</label>
                            <input type="text" name="addcus_mapurl" id="addcus_mapurl" class="form-control form-control-sm">
                        </div>
                    </div>
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <textarea name="addcus_customer_product" id="addcus_customer_product" cols="30" rows="3" class="form-control"></textarea>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        ...
                        <textarea name="addcus_forecast" id="addcus_forecast" cols="30" rows="4" class="form-control"></textarea>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4 form-group crf_file3">
                        ...
                        <input type="file" name="addcus_file3" id="addcus_file3" class="form-control form-control-sm" accept=".pdf, .jpg, .png">
                    </div>
                    <div class="col-md-4 form-group crf_file4">
                        <label for="">งบแสดงฐานะทางการเงิน</label><br>
                        <input type="file" name="addcus_file4" id="addcus_file4" class="form-control form-control-sm" accept=".pdf, .jpg, .png">
                    </div>
                    <div class="col-md-4 crf_file5">
                        <label for="">งบกำไรขาดทุน</label><br>
                        <input type="file" name="addcus_file5" id="addcus_file5" class="form-control form-control-sm" accept=".pdf, .jpg, .png">
                    </div>
                    <div class="col-md-4 crf_file6">
                        <label for="">อัตราส่วนสภาพคล่อง</label>
                        <input type="file" name="addcus_file6" id="addcus_file6" class="form-control form-control-sm" accept=".pdf, .jpg, .png">
                    </div>
                </div>
