    ...
    if ($('#checkPageAddTH').val() == "addTH") {
        ...
        $('input:radio[name="crf_type"]').click(function () {
            if ($(this).val() == 1) {
                ...
                $('.crf_condition_bill2 , .crf_condition_bill3 , .recive_cheuqe').css('display', 'none');
